package com.carson.order.aspect;

import com.carson.order.annotation.Limit;
import com.carson.order.util.MyStringUtils;
import com.carson.order.util.RequestHolder;
...
public class LimitAspect {
    ...
    @Pointcut("@annotation(com.carson.order.annotation.Limit)")
